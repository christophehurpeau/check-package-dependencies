...
describe("identical-versions-than-dev-dependency-of-dependency", () => {
  it("should report when version does not match dev dependency's version", async () => {
    ...
    const eslint = new ESLint({
      ...
      overrideConfig: {
        rules: {
          "check-package-dependencies-test/identical-versions-than-dev-dependency-of-dependency":
            [
              "error",
              {
                dependencies: {
