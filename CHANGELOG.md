...
* replace the recommended-library config with a "library" setting (#894)

### Features

* replace the recommended-library config with a "library" setting ([#894](https://github.com/christophehurpeau/check-package-dependencies/issues/894))
...
* add support for workspace:* in more rules
...
* **deps:** update eslint monorepo to v10.4.1 ([#865](https://github.com/christophehurpeau/check-package-dependencies/issues/865))
...
* properly autofix checkIdenticalVersions
