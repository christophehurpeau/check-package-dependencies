...
export type CommentedRange = string | (Commented & {
    range: string;
});
export declare const resolveCommentedRange: (value: CommentedRange) => Commented & {
    range: string;
};
/**
 ...
 */
export declare const omitComment: <T extends Commented>({ comment, ...entry }: T) => Omit<T, "comment">;
