...
import { createMockReportError } from "./ReportError.testUtils.js";
import { createCliReportError, displayMessages, logMessage, reportNotWarnedForMapping, resetMessages, } from "./cliErrorReporting.js";
afterEach(() => {
    process.exitCode = 0;
});
describe("logMessage", () => {
...
//# sourceMappingURL=cliErrorReporting.test.js.map