...
function resolvePackageJsonPaths(directory) {
...
const resolvePackageJsonPathsOrFail = (directory) => {
  try {
...
async function main(argv) {
  ...
  const results = options.quiet ? ESLint.getErrorResults(allResults) : allResults;
...
export { hasError, main, parseCliArgs, resolvePackageJsonPaths };
