...
describe("checkDuplicateDependencies", () => {
    ...
    it("should report error when is in multiple types and not a library", () => {
        checkDuplicateDependencies(mockReportError, parsePkgValue({
            name: "test",
        ...
        assertSingleMessage(messages, {
            errorMessage: 'Invalid "rollup" present in dependencies and devDependencies',
    ...
    it("should report error when is in multiple types with same version and is a library", () => {
        ...
        assertSingleMessage(messages, {
            errorMessage: 'Invalid "rollup" has same version in dependencies and devDependencies',
    ...
    it("should report error when dependency does not intersect", () => {
        ...
        assertSingleMessage(messages, {
            ...
            errorDetails: '"1.0.0" should satisfies "^2.0.0" from some-lib-using-rollup in dependencies',
            onlyWarns: false,
            dependency: {
                name: "rollup",
    ...
    it("should report error when dependency is in peerDependencies and allowPeerDependencies is false", () => {
        ...
        assertSingleMessage(messages, {
            errorMessage: "Invalid duplicate dependency",
            errorDetails: '"1.0.0" should satisfies "^2.0.0" from some-lib-using-rollup in peerDependencies',
            onlyWarns: false,
            dependency: {
                name: "rollup",
                fieldName: "devDependencies",
    ...
    it("should not report error when dependency's value is latest", () => {
        ...
        }), true, "dependencies", ["devDependencies"], {
            name: "some-lib-using-rollup",
