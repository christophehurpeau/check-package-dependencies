...
describe("checkIdenticalVersions", () => {
    ...
    describe("devDependencies in array", () => {
        it("should return no error when all versions are identical", () => {
            ...
            expect(createReportError).toHaveBeenCalledWith("Identical Versions", "path");
        ...
        it("should return error when versions are not identical", () => {
            ...
            expect(mockReportError).toHaveBeenCalledWith('Invalid "react-dom" in devDependencies', 'expecting "1.0.1" be "1.0.0".', undefined);
        });
    });
    describe("object with dependencies and devDependencies", () => {
        ...
        it("should return error when versions are not identical", () => {
            ...
            expect(mockReportError).toHaveBeenCalledWith('Invalid "react-dom" in dependencies', 'expecting "1.0.1" be "1.0.0".', undefined);
            expect(mockReportError).toHaveBeenCalledWith('Invalid "react-test-renderer" in devDependencies', 'expecting "1.0.1" be "1.0.0".', undefined);
        });
    });
});
